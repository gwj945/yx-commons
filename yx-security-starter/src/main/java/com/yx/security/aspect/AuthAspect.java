package com.yx.security.aspect;
...
public class AuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.yx.base.controller.*.*(..)) || " +
            "@annotation(com.yx.security.annotation.PreAuth) || " +
            "@within(com.yx.security.annotation.PreAuth)"
    )
