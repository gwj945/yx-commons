...
import com.yx.log.event.SysLogEvent;
import com.yx.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.yx.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.yx.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.yx.log.annotation.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.yx.base.controller.*.*(..)) || @annotation(com.yx.log.annotation.SysLog)")
