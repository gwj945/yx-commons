...
import com.yx.injection.annonation.InjectionField;
import com.yx.injection.annonation.InjectionResult;
...
public class InjectionCore {
    ...
    private boolean isNotBaseType(Object obj, Field field) {
        ...
        if ("java.lang.Integer".equals(typeName) ||
                ...
                "com.yx.model.RemoteData".equals(typeName)
        ) {
            return false;
        } else {
            return true;
